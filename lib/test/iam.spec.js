...
describe('During gathering the action criteria', function(){
    ...
    it('realistic statement', function(){
        ...
        expect(iam.authorize(['ssrn:ss:sp::1000:blah/2134'], 'CanRead',processedIam)).to.equal(true);
        expect(iam.authorize(['ssrn:ss:sp::1000:one/2134'], 'CanRead',processedIam)).to.equal(false);
        expect(iam.authorize(['ssrn:ss:sp::1000:one/100'], 'CanRead',processedIam)).to.equal(true);
        expect(iam.authorize(['ssrn:ss:sp::1000:blah/2134','ssrn:ss:sp::1000:one/2134'], 'CanRead',processedIam)).to.equal(false);
        expect(iam.authorize(['ssrn:ss:sp::1000:'], 'CanRead',processedIam)).to.equal(true);
    });
